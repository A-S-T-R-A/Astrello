...
import { DemoCardModal, useCardModal } from "@/_entities/Card";
import { useDatabase } from "@/_shared/hooks/useDatabase";
import { fetcher } from "@/_shared/lib/fetcher";
import { DemoCopyCard } from "@/_features/card/CopyCard";
import { DemoDeleteCard } from "@/_features/card/DeleteCard";
import { DemoAddCardDescription } from "@/_features/card/AddCardDescription";
import { DemoCreateList } from "@/_features/list/CreateList";
import { DemoUpdateCard } from "@/_features/card/UpdateCard";
...
export function ListContainer({ data, boardId }: ListContainerProps) {
  ...
  return (
    <>
      ...
      {cardData && (
        <DemoCardModal
          header={<DemoUpdateCard data={cardData} />}
          actions={[
            <DemoCopyCard data={cardData} key="copy-card-action" />,
            <DemoDeleteCard data={cardData} key="copy-card-action" />
          ]}
          description={<DemoAddCardDescription data={cardData} />}
        />
      )}
    </>
  );
