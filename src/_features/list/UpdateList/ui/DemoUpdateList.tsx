...
import { demoUpdateListAction } from "../model/services/demoUpdateListAction";

type TUpdateListProps = {
  data: List;
};

export function DemoUpdateList({ data }: TUpdateListProps) {
  ...
  const { execute } = useDatabase(demoUpdateListAction, {
    onSuccess: (data) => {
