...
import { demoCopyListAction } from "../model/services/demoCopyListAction";
...
export function DemoCopyList({ data, onSuccess }: TListActionsProps) {
  const { execute: executeCopy } = useDatabase(demoCopyListAction, {
    onSuccess: (data) => {
